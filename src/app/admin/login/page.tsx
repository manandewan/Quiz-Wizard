...
export default function TeacherLoginPage() {
  ...
  return (
    <div className="teacher-theme min-h-screen bg-slate-950 flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" id="teacher-login-form">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-slate-900/80 border border-slate-800 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
                  disabled={loading}
                />
              </div>
              ...
              <button
                ...
                id="admin-submit-btn"
                disabled={loading}
                className="w-full py-3.5 rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold text-sm shadow-lg shadow-purple-500/20 active:scale-[0.98] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none"
              >
